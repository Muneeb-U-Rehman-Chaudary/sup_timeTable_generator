...
export default function Home() {
  ...
  const handleSectionClick = async (sec: string) => {
    ...
    if (
      data &&
      (!data.sectionData[sec] || data.sectionData[sec].entries.length === 0) &&
  ...
  const c = {
    ...
    spinnerClr1: "#7c5cfc",
    spinnerClr2: "#a78bfa",
    aiBg: "rgba(124,92,252,0.06)",
    aiBorder: "rgba(124,92,252,0.25)",
  };
        ...
        >
          {Array.from({ length: 15 }).map((_, i) => (
            <div
              ...
              style={{
                borderRadius: 3,
                background: [2, 4, 7, 9, 11, 13].includes(i)
          ...
          {["BSSE-4A", "BSAI-3B", "BSDS-2C"].map((label, i) => (
            <div
              ...
              style={{
                ...
                background:
                  i === 0 ? "rgba(124,92,252,0.2)" : "rgba(255,255,255,0.03)",
  ...
  // Split AI analysis into lines and clean up bullets
  const aiLines = data?.aiAnalysis
      ...
      {!data ? (
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "600px",
                  background:
                    "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(124,92,252,0.30) 0%, rgba(124,92,252,0.08) 40%, transparent 70%)",
                }}
              />
              {/* Left beam */}
              <div
                ...
                style={{
                  ...
                  height: "550px",
                  background:
                    "linear-gradient(180deg, rgba(124,92,252,0.28) 0%, rgba(99,102,241,0.12) 40%, transparent 80%)",
              ...
              <div
                ...
                style={{
                  ...
                  height: "500px",
                  background:
                    "linear-gradient(180deg, rgba(168,85,247,0.20) 0%, rgba(59,130,246,0.10) 50%, transparent 85%)",
            ...
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(90deg, transparent, rgba(124,92,252,0.12) 30%, rgba(168,85,247,0.18) 50%, rgba(59,130,246,0.12) 70%, transparent)",
                pointerEvents: "none",
              }}
            />
              ...
              {loading ? (
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ color: c.fgDim, fontSize: 13, marginTop: 4 }}>
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        pointerEvents: "none",
                        background:
                          "radial-gradient(circle at 50% 80%, rgba(124,92,252,0.06) 0%, transparent 60%)",
                      }}
                    />
                    <div
                      style={{
          ...
          >
            ...
            <span>
              &copy; {new Date().getFullYear()} Muneeb u Rehman &middot;
              Superior University
            </span>
          </footer>
        </div>
        ...
        >
          {/* Header row */}
          <div
            className="results-header fade-in-up"
            style={{
              display: "flex",
              flexWrap: "wrap",
              alignItems: "center",
          ...
          >
            ...
            >
              {activeSection && (
                <button
                  onClick={() => downloadPDF(activeSection)}
                  ...
                  style={{
                    ...
                    padding: "8px 18px",
                    background:
                      downloading === "single" ? c.accentHover : c.accent,
                    color: "#fff",
                    border: "none",
                    borderRadius: 8,
                    fontSize: 13,
                    ...
                    opacity: downloading && downloading !== "single" ? 0.5 : 1,
                    transition: "all 0.15s",
                  }}
                >
                  {downloading === "single" ? (
              ...
              {sectionKeys.length > 1 && (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    cursor: downloading ? "not-allowed" : "pointer",
                    opacity: downloading && downloading !== "all" ? 0.5 : 1,
                    transition: "all 0.15s",
                  }}
                >
                  {downloading === "all" ? (
          ...
          {sectionKeys.length > 1 &&
            (() => {
              const filtered = sectionSearch.trim()
                ? sectionKeys.filter((s) =>
                    s.toLowerCase().includes(sectionSearch.toLowerCase()),
                  )
                : sectionKeys;
              return (
                <div
                  className="section-selector fade-in-up delay-1"
                  style={{
                    marginBottom: 20,
                    padding: "14px 16px",
                    background: c.card,
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border:
                            activeSection === sec
                              ? "none"
                              : `1px solid ${c.badgeBorder}`,
                          background:
                            activeSection === sec
                              ? c.activeBadgeBg
                              : "transparent",
                          color:
                            activeSection === sec ? c.activeBadgeFg : c.badgeFg,
          ...
          {/* View toggle */}
          <div
            className="view-toggle fade-in-up delay-2"
            style={{
              display: "inline-flex",
              gap: 1,
              marginBottom: 20,
          ...
          {activeSectionData && activeSectionData.entries.length > 0 ? (
                    ...
                    <tbody>
                      {activeSectionData.times.map((ti, rowIdx) => (
                        <tr
                          key={ti}
                          style={{
                            animation: `tableRowFade 0.3s ease-out ${rowIdx * 0.04}s both`,
                          }}
                        >
                          <td
                            style={{
                            ...
                            return (
                              <td
                                ...
                                style={{
                                  ...
                                  background: cell ? c.filledBg : "transparent",
                                  minWidth: 110,
                                  verticalAlign: "top",
                                }}
                              >
                                {cell ? (
                                  ...
                                  <span
                                    style={{ color: c.fgDim, fontSize: 10 }}
                                  >
                                    -
                                  </span>
                                )}
                    ...
                    <tbody>
                      {activeSectionData.entries.map((e, i) => (
                        <tr
                          key={i}
                          style={{
                            background: i % 2 === 0 ? "#0d0b14" : "#0a0a0a",
                            animation: `tableRowFade 0.3s ease-out ${i * 0.03}s both`,
                          }}
                        >
                          <td style={dtdStyle(c)}>{i + 1}</td>
                          <td style={{ ...dtdStyle(c), fontWeight: 600 }}>
                            {e.day}
                          </td>
              ...
              {viewMode === "list" && (
                <div className="table-wrap">
                  ...
                  >
                    <thead>
                      <tr>
                        {["#", "Day", "Time", "Subject", "Teacher", "Room"].map(
                          (h) => (
                            <th key={h} style={thStyle(c)}>
                              {h}
                            </th>
                          ),
                        )}
            ...
            >
              <p style={{ color: c.fgMuted, fontSize: 13 }}>
              ...
              {sectionKeys.length > 0 ? (
                ...
                <button
                  onClick={() =>
                    storedFileRef.current &&
                    handleUpload(storedFileRef.current, "")
                  }
                  style={{
                    marginTop: 12,
                    padding: "8px 20px",
